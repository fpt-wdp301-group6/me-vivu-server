...
User.methods.generateAccessToken = function () {
    return jwt.sign({ id: this._id, role: this.role }, process.env.ACCESS_TOKEN, { expiresIn: '10m' });
};

User.methods.generateRefreshToken = function () {
    return jwt.sign({ id: this._id, role: this.role }, process.env.REFRESH_TOKEN, { expiresIn: '30d' });
};
